<div class="container">
    ...
    <div class="row mt-3">
        ...
        <tbody>
            ...
            <td>
                <a href="<?php echo base_url(); ?>mahasiswa/edit/<?php echo $mhs->npm ?>" class="badge text-bg-info">Edit</a>
                <a href="<?php echo base_url(); ?>mahasiswa/delete/<?php echo $mhs->npm ?>" class="badge text-bg-danger" onclick="return confirm('Delete this mahasiswa?');">Delete</a>
            </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
